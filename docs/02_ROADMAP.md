...
5. **Team org-tree layout** (§11) — needs a `department` field added to `models/Team.js` plus a new tree presentation component; existing CMS data is reused as-is. Next highest-leverage gap.
