...
export default function ProductsPagination({ pagination, onPageChange }) {
  ...
  return (
    <nav className="mt-8 flex items-center justify-center gap-1.5" aria-label="Products pagination">
      <button
        type="button"
