...
export default function WhatWeDoSectionForm({ data, onSave }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl2 border border-line bg-surface p-5 sm:p-6">
        <h3 className="font-display text-sm font-bold text-primary-dark">Cards</h3>
        <p className="mt-0.5 mb-3 text-xs text-muted">
          Real photography, no icons — shown in order, left to right. Only active cards appear on
          the public homepage.
        </p>
        <CardListEditor
          items={form.cards}
